...
export default function ServiceCard({
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="w-[90%] md:w-full max-w-50 md:max-w-none mx-auto aspect-square md:aspect-6/5 overflow-hidden bg-background mb-comfortable">
        {imageSrc ? (
          <img
            src={imageSrc}
            alt={imageAlt}
      ...
      {/* Title */}
      <h3 className="text-foreground text-xl md:text-3xl mx-auto font-medium mb-heading-text text-left">
        {title}
      </h3>
